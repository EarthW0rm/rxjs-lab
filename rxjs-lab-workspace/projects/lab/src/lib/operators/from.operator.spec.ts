...
describe('Operador: from', () => {
	...
	it('Utilizando o operador from para lidar com varios itens no next', done => {
		const fromObservable: Observable<string> = from(['Sua falta de fé é perturbadora.', 'Você está controlando seu medo... agora libere a sua raiva. Só o seu ódio poderá destruir-me.', 'Você não conhece o poder do lado sombrio', 'Luke, eu sou seu pai!' ]);
